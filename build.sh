...
create_lib_for_sdks  "${LIB_DEST_DIR}/libcrypto-ios.a"  lib/libcrypto.a   iphoneos iphonesimulator iphonesimulator8.0
create_lib_for_sdks  "${LIB_DEST_DIR}/libcrypto-osx.a"  lib/libcrypto.a   macosx
create_lib_for_sdks  "${LIB_DEST_DIR}/libssl-ios.a"     lib/libssl.a      iphoneos iphonesimulator iphonesimulator8.0
create_lib_for_sdks  "${LIB_DEST_DIR}/libssl-osx.a"     lib/libssl.a      macosx

# Copy header files + final cleanups
cp -R "${TEMP_LIB_PATH}-${SDKS[0]}-${ARCHS[0]}/include" "${HEADER_DEST_DIR}"
# rm -rf "$TEMP_DIR"
